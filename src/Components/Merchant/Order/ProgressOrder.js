    ...
    return (
      ...
      <main className="mt-5 pt-5">
        ...
        <div className="d-flex justify-content-between top-content">
            <h4>Progress Order Page Section</h4>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="d-flex justify-content-center align-items-center">
                      ...
                      <Link to='/edit-progress-order'> <i className="fas fa-edit " style={{color: "#660000"}}></i></Link>
...
export default ProgressOrderMerchant;